...
let rootUrl = URL(string: "https://twa.bitsgap.com/bot?utm_source=app_bound_domain")!

// allowed origin is for what we are sticking to pwa domain
// This should also appear in Info.plist
let allowedOrigins: [String] = ["bitsgap.com"]

// auth origins will open in modal and show toolbar for back into the main origin.
// These should also appear in Info.plist
let authOrigins: [String] = ["facebook.com"]
// allowedOrigins + authOrigins <= 10

// subdomains that are allowed, but must be forced to open in the popup
let allowedOriginsForcedPopupMode: [String] = ["helpdesk.bitsgap.com"];
